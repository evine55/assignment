...
public class Salary extends Deduction {
    ...
    public Salary(int id, String createdDate, String updatedDate, String companyName,
        ...
        if (grossSalary <= 0) throw new PayrollDataException("Gross salary must be greater than 0");
        if (netSalary <= 0) throw new PayrollDataException("Net salary must be greater than 0");
    ...
    public String toString() {
        return super.toString() + "\nSalary [Basic=" + basicSalary + ", Gross=" + grossSalary + ", Net=" + netSalary + "]";
    }
}
